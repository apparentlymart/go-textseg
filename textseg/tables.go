...
var _GraphemePrepend = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x113d1, Hi: 0x113d1, Stride: 0x1},
...
var _GraphemeSpacingMark = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0xcc1, Hi: 0xcc1, Stride: 0x1},
		...
		unicode.Range16{Lo: 0x1b3e, Hi: 0x1b41, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa952, Hi: 0xa952, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa9be, Hi: 0xa9bf, Stride: 0x1},
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x111bf, Hi: 0x111bf, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x1134b, Hi: 0x1134c, Stride: 0x1},
		unicode.Range32{Lo: 0x11362, Hi: 0x11363, Stride: 0x1},
		unicode.Range32{Lo: 0x113b9, Hi: 0x113ba, Stride: 0x1},
		unicode.Range32{Lo: 0x113ca, Hi: 0x113ca, Stride: 0x1},
		unicode.Range32{Lo: 0x113cc, Hi: 0x113cd, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x1171e, Hi: 0x1171e, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x1612a, Hi: 0x1612c, Stride: 0x1},
...
var _GraphemeV = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		unicode.Range32{Lo: 0x16d63, Hi: 0x16d63, Stride: 0x1},
		unicode.Range32{Lo: 0x16d67, Hi: 0x16d6a, Stride: 0x1},
	},
	LatinOffset: 0,
}
...
var _WordALetter = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x1c80, Hi: 0x1c8a, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa790, Hi: 0xa7cd, Stride: 0x1},
		unicode.Range16{Lo: 0xa7d0, Hi: 0xa7d1, Stride: 0x1},
		unicode.Range16{Lo: 0xa7d3, Hi: 0xa7d3, Stride: 0x1},
		unicode.Range16{Lo: 0xa7d5, Hi: 0xa7dc, Stride: 0x1},
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x105c0, Hi: 0x105f3, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x10d4a, Hi: 0x10d4d, Stride: 0x1},
		unicode.Range32{Lo: 0x10d4e, Hi: 0x10d4e, Stride: 0x1},
		unicode.Range32{Lo: 0x10d4f, Hi: 0x10d4f, Stride: 0x1},
		unicode.Range32{Lo: 0x10d50, Hi: 0x10d65, Stride: 0x1},
		unicode.Range32{Lo: 0x10d6f, Hi: 0x10d6f, Stride: 0x1},
		unicode.Range32{Lo: 0x10d70, Hi: 0x10d85, Stride: 0x1},
		unicode.Range32{Lo: 0x10e80, Hi: 0x10ea9, Stride: 0x1},
		unicode.Range32{Lo: 0x10eb0, Hi: 0x10eb1, Stride: 0x1},
		unicode.Range32{Lo: 0x10ec2, Hi: 0x10ec4, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x11380, Hi: 0x11389, Stride: 0x1},
		unicode.Range32{Lo: 0x1138b, Hi: 0x1138b, Stride: 0x1},
		unicode.Range32{Lo: 0x1138e, Hi: 0x1138e, Stride: 0x1},
		unicode.Range32{Lo: 0x11390, Hi: 0x113b5, Stride: 0x1},
		unicode.Range32{Lo: 0x113b7, Hi: 0x113b7, Stride: 0x1},
		unicode.Range32{Lo: 0x113d1, Hi: 0x113d1, Stride: 0x1},
		unicode.Range32{Lo: 0x113d3, Hi: 0x113d3, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x11bc0, Hi: 0x11be0, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x13460, Hi: 0x143fa, Stride: 0x1},
		unicode.Range32{Lo: 0x14400, Hi: 0x14646, Stride: 0x1},
		unicode.Range32{Lo: 0x16100, Hi: 0x1611d, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x16d40, Hi: 0x16d42, Stride: 0x1},
		unicode.Range32{Lo: 0x16d43, Hi: 0x16d6a, Stride: 0x1},
		unicode.Range32{Lo: 0x16d6b, Hi: 0x16d6c, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x1e5d0, Hi: 0x1e5ed, Stride: 0x1},
		unicode.Range32{Lo: 0x1e5f0, Hi: 0x1e5f0, Stride: 0x1},
...
var _WordExtend = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x11366, Hi: 0x1136c, Stride: 0x1},
		unicode.Range32{Lo: 0x11370, Hi: 0x11374, Stride: 0x1},
		unicode.Range32{Lo: 0x113b8, Hi: 0x113ba, Stride: 0x1},
		unicode.Range32{Lo: 0x113bb, Hi: 0x113c0, Stride: 0x1},
		unicode.Range32{Lo: 0x113c2, Hi: 0x113c2, Stride: 0x1},
		unicode.Range32{Lo: 0x113c5, Hi: 0x113c5, Stride: 0x1},
		unicode.Range32{Lo: 0x113c7, Hi: 0x113ca, Stride: 0x1},
		unicode.Range32{Lo: 0x113cc, Hi: 0x113cd, Stride: 0x1},
		unicode.Range32{Lo: 0x113ce, Hi: 0x113ce, Stride: 0x1},
		unicode.Range32{Lo: 0x113cf, Hi: 0x113cf, Stride: 0x1},
		unicode.Range32{Lo: 0x113d0, Hi: 0x113d0, Stride: 0x1},
...
var _WordNumeric = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x19da, Hi: 0x19da, Stride: 0x1},
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x10d40, Hi: 0x10d49, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x116d0, Hi: 0x116e3, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x11bf0, Hi: 0x11bf9, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x16130, Hi: 0x16139, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x16d70, Hi: 0x16d79, Stride: 0x1},
		unicode.Range32{Lo: 0x1ccf0, Hi: 0x1ccf9, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x1e5f1, Hi: 0x1e5fa, Stride: 0x1},
...
var _SentenceLower = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x1c8a, Hi: 0x1c8a, Stride: 0x1},
		unicode.Range16{Lo: 0x1d00, Hi: 0x1d2b, Stride: 0x1},
		unicode.Range16{Lo: 0x1d2c, Hi: 0x1d6a, Stride: 0x1},
		unicode.Range16{Lo: 0x1d6b, Hi: 0x1d77, Stride: 0x1},
		unicode.Range16{Lo: 0x1d78, Hi: 0x1d78, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa7cd, Hi: 0xa7cd, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa7db, Hi: 0xa7db, Stride: 0x1},
		unicode.Range16{Lo: 0xa7f2, Hi: 0xa7f4, Stride: 0x1},
...
var _SentenceOLetter = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x18cff, Hi: 0x18d08, Stride: 0x1},
		unicode.Range32{Lo: 0x1aff0, Hi: 0x1aff3, Stride: 0x1},
		unicode.Range32{Lo: 0x1aff5, Hi: 0x1affb, Stride: 0x1},
		unicode.Range32{Lo: 0x1affd, Hi: 0x1affe, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x2ebf0, Hi: 0x2ee5d, Stride: 0x1},
...
var _SentenceSContinue = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x3a, Hi: 0x3b, Stride: 0x1},
		unicode.Range16{Lo: 0x37e, Hi: 0x37e, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xfe13, Hi: 0xfe14, Stride: 0x1},
		unicode.Range16{Lo: 0xfe31, Hi: 0xfe32, Stride: 0x1},
		unicode.Range16{Lo: 0xfe50, Hi: 0xfe51, Stride: 0x1},
		unicode.Range16{Lo: 0xfe54, Hi: 0xfe55, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xff1a, Hi: 0xff1b, Stride: 0x1},
...
var _SentenceSTerm = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x17d4, Hi: 0x17d5, Stride: 0x1},
		...
		unicode.Range16{Lo: 0x1b4e, Hi: 0x1b4f, Stride: 0x1},
		unicode.Range16{Lo: 0x1b5a, Hi: 0x1b5b, Stride: 0x1},
		unicode.Range16{Lo: 0x1b5e, Hi: 0x1b5f, Stride: 0x1},
		unicode.Range16{Lo: 0x1b7d, Hi: 0x1b7f, Stride: 0x1},
		...
		unicode.Range16{Lo: 0x2cf9, Hi: 0x2cfb, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xfe12, Hi: 0xfe12, Stride: 0x1},
		unicode.Range16{Lo: 0xfe15, Hi: 0xfe16, Stride: 0x1},
	...
	R32: []unicode.Range32{
		...
		unicode.Range32{Lo: 0x113d4, Hi: 0x113d5, Stride: 0x1},
		...
		unicode.Range32{Lo: 0x16d6e, Hi: 0x16d6f, Stride: 0x1},
...
var _SentenceUpper = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		unicode.Range16{Lo: 0x10cd, Hi: 0x10cd, Stride: 0x1},
		unicode.Range16{Lo: 0x13a0, Hi: 0x13f5, Stride: 0x1},
		unicode.Range16{Lo: 0x1c89, Hi: 0x1c89, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa7cb, Hi: 0xa7cc, Stride: 0x1},
		...
		unicode.Range16{Lo: 0xa7da, Hi: 0xa7da, Stride: 0x1},
		unicode.Range16{Lo: 0xa7dc, Hi: 0xa7dc, Stride: 0x1},
