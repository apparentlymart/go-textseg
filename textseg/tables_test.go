...
//      maketesttables --url=http://www.unicode.org/Public/10.0.0/ucd/auxiliary/
// DO NOT EDIT
...
var unicodeGraphemeTests = []struct {
	...
	{
		input:  []byte{0x20, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x20}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x20, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x20, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xd, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xd, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd}, []byte{0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xa, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xa}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xa, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xa}, []byte{0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x1, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x1}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x1, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x1}, []byte{0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xcc, 0x80, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xcc, 0x80}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xcc, 0x80, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xcc, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xd8, 0x80, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd8, 0x80, 0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xd8, 0x80, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd8, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe0, 0xa4, 0x83, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe0, 0xa4, 0x83}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe0, 0xa4, 0x83, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe0, 0xa4, 0x83, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe1, 0x84, 0x80, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x84, 0x80}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe1, 0x84, 0x80, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x84, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe1, 0x85, 0xa0, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x85, 0xa0}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe1, 0x85, 0xa0, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x85, 0xa0, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe1, 0x86, 0xa8, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x86, 0xa8}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe1, 0x86, 0xa8, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe1, 0x86, 0xa8, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xea, 0xb0, 0x80, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xea, 0xb0, 0x80}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xea, 0xb0, 0x80, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xea, 0xb0, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xea, 0xb0, 0x81, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xea, 0xb0, 0x81}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xea, 0xb0, 0x81, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xea, 0xb0, 0x81, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xf0, 0x9f, 0x87, 0xa6, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x87, 0xa6}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xf0, 0x9f, 0x87, 0xa6, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x87, 0xa6, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe2, 0x98, 0x9d, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x98, 0x9d}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x98, 0x9d, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x98, 0x9d, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xf0, 0x9f, 0x8f, 0xbb, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x8f, 0xbb}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xf0, 0x9f, 0x8f, 0xbb, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x8f, 0xbb, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe2, 0x80, 0x8d, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x80, 0x8d, 0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x80, 0x8d, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x80, 0x8d, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x20},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x20}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x20},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x20}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xd},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xd}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xd},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xd}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xa},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xa}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xa},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xa}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x1},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x1}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x1},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x1}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xcc, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xcc, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xd8, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xd8, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xd8, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xd8, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe0, 0xa4, 0x83},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xe0, 0xa4, 0x83}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe0, 0xa4, 0x83},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe0, 0xa4, 0x83}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe1, 0x84, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe1, 0x84, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe1, 0x84, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe1, 0x84, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe1, 0x85, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe1, 0x85, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe1, 0x85, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe1, 0x85, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe1, 0x86, 0xa8},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe1, 0x86, 0xa8}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe1, 0x86, 0xa8},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe1, 0x86, 0xa8}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xea, 0xb0, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xea, 0xb0, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xea, 0xb0, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xea, 0xb0, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xea, 0xb0, 0x81},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xea, 0xb0, 0x81}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xea, 0xb0, 0x81},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xea, 0xb0, 0x81}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xf0, 0x9f, 0x87, 0xa6},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xf0, 0x9f, 0x87, 0xa6}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xf0, 0x9f, 0x87, 0xa6},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xf0, 0x9f, 0x87, 0xa6}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe2, 0x98, 0x9d},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe2, 0x98, 0x9d}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe2, 0x98, 0x9d},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x98, 0x9d}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xf0, 0x9f, 0x8f, 0xbb},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xf0, 0x9f, 0x8f, 0xbb}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xf0, 0x9f, 0x8f, 0xbb},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xf0, 0x9f, 0x8f, 0xbb}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe2, 0x80, 0x8d},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xe2, 0x80, 0x8d}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe2, 0x80, 0x8d},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe2, 0x80, 0x8d}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xf0, 0x9f, 0x91, 0xa6},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xf0, 0x9f, 0x91, 0xa6}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xf0, 0x9f, 0x91, 0xa6},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xf0, 0x9f, 0x91, 0xa6}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcd, 0xb8},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xcd, 0xb8}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xcd, 0xb8},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xcd, 0xb8}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xef, 0xbf, 0xbd},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xef, 0xbf, 0xbd}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xef, 0xbf, 0xbd},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xef, 0xbf, 0xbd}},
	},
	{
	...
	{
		input:  []byte{0xf0, 0x9f, 0x91, 0xa6, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x91, 0xa6}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xf0, 0x9f, 0x91, 0xa6, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x91, 0xa6, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xcd, 0xb8, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xcd, 0xb8}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xcd, 0xb8, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xcd, 0xb8, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xef, 0xbf, 0xbd, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xef, 0xbf, 0xbd}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xef, 0xbf, 0xbd, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xef, 0xbf, 0xbd}, []byte{0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
...
var unicodeWordTests = []struct {
	...
	{
		input:  []byte{0x1, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x1, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x1, 0xf0, 0x9f, 0x91, 0xa6},
		output: [][]byte{[]byte{0x1}, []byte{0xf0, 0x9f, 0x91, 0xa6}},
	...
	{
		input:  []byte{0xb, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xb}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xb, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xb}, []byte{0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe3, 0x80, 0xb1, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe3, 0x80, 0xb1}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xe3, 0x80, 0xb1, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xe3, 0x80, 0xb1, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x41, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x41}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x41, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x41, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x3a, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x3a}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x3a, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x3a, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x2c, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x2c}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x2c, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x2c, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x2e, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x2e}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x2e, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x2e, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x30, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x30}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x30, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x30, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x5f, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x5f}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x5f, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x5f, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xd7, 0x90, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd7, 0x90}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xd7, 0x90, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xd7, 0x90, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x22, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x22}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x22, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x22, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x27, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x27}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x27, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x27, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xb},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xb}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xb},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xb}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe3, 0x80, 0xb1},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe3, 0x80, 0xb1}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xe3, 0x80, 0xb1},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xe3, 0x80, 0xb1}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x41},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x41}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x41},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x41}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x2e},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x2e}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x2e},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x2e}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x30},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x30}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x30},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x30}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x5f},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x5f}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x5f},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x5f}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xf0, 0x9f, 0x87, 0xa6},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xf0, 0x9f, 0x87, 0xa6}},
	...
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xd7, 0x90},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xd7, 0x90}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xd7, 0x90},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0xd7, 0x90}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x22},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x22}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x22},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x22}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xe2, 0x98, 0x9d},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0xe2, 0x98, 0x9d}},
	...
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xc2, 0xad},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xc2, 0xad}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xc2, 0xad},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0xc2, 0xad}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x80},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x80}},
	...
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x61, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x61, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x61, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x61, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x61, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x61}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x61, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x61}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x61, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x61}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x61, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x61}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x61, 0x27, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x61}, []byte{0x27, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x61, 0x27, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x61}, []byte{0x27, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x61, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x61}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x61, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x61}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x31, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x31}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x31, 0x3a},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x31}, []byte{0x3a}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x31, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x31}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x31, 0x27},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x31}, []byte{0x27}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x31, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x31}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x31, 0x2c},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x31}, []byte{0x2c}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0x31, 0x2e, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80}, []byte{0x31}, []byte{0x2e, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xe2, 0x99, 0x80, 0xcc, 0x88, 0x31, 0x2e, 0xe2, 0x81, 0xa0},
		output: [][]byte{[]byte{0xe2, 0x99, 0x80, 0xcc, 0x88}, []byte{0x31}, []byte{0x2e, 0xe2, 0x81, 0xa0}},
	},
	{
		input:  []byte{0xf0, 0x9f, 0x91, 0xa6, 0x1},
		output: [][]byte{[]byte{0xf0, 0x9f, 0x91, 0xa6}, []byte{0x1}},
	...
	{
		input:  []byte{0xc2, 0xad, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xc2, 0xad}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0xc2, 0xad, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0xc2, 0xad, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x61, 0xe2, 0x81, 0xa0, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61, 0xe2, 0x81, 0xa0}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x61, 0xe2, 0x81, 0xa0, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61, 0xe2, 0x81, 0xa0, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x61, 0x3a, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x3a}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x61, 0x3a, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x3a, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x61, 0x27, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x27}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x61, 0x27, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x27, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x61, 0x27, 0xe2, 0x81, 0xa0, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x27, 0xe2, 0x81, 0xa0}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x61, 0x27, 0xe2, 0x81, 0xa0, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x27, 0xe2, 0x81, 0xa0, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x61, 0x2c, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x2c}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x61, 0x2c, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x61}, []byte{0x2c, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x31, 0x3a, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x3a}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x31, 0x3a, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x3a, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x31, 0x27, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x27}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x31, 0x27, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x27, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x31, 0x2c, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x2c}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x31, 0x2c, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x2c, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
	...
	{
		input:  []byte{0x31, 0x2e, 0xe2, 0x81, 0xa0, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x2e, 0xe2, 0x81, 0xa0}, []byte{0xe2, 0x99, 0x80}},
	},
	{
		input:  []byte{0x31, 0x2e, 0xe2, 0x81, 0xa0, 0xcc, 0x88, 0xe2, 0x99, 0x80},
		output: [][]byte{[]byte{0x31}, []byte{0x2e, 0xe2, 0x81, 0xa0, 0xcc, 0x88}, []byte{0xe2, 0x99, 0x80}},
	},
	{
